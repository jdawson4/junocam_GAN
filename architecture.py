...
def gen():
    ...
    de1 = keras.layers.Dropout(0.25)(keras.layers.Add()([en2,gen_decoder_block(16)(drop)]))
    de2 = keras.layers.Add()([en1,gen_decoder_block(8)(de1)])
    de3 = gen_decoder_block(8)(de2)
    output1 = keras.layers.Conv2D(8,(1,1),(1,1),padding='same',activation=None)(de3)
    output2 = keras.layers.Conv2D(8,(3,3),(1,1),padding='same',activation=None)(de3)
    output3 = keras.layers.Conv2D(8,(5,5),(1,1),padding='same',activation=None)(de3)
...
def dis():
    ...
    out = dis_block(8,scale,batchnorm=False)
